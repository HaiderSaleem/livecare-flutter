...
class ServiceRequestListScreen extends BaseScreen {
  const ServiceRequestListScreen({Key? key}) : super(key: key);

  @override
  _ServiceRequestListScreenState createState() => _ServiceRequestListScreenState();
}

class _ServiceRequestListScreenState extends BaseScreenState<ServiceRequestListScreen> with LocalNotificationObserver, SocketDelegate {
  ...
  _requestGetRequests(bool forceLoad) {
    ...
    if (NetworkReachabilityManager.sharedInstance.isConnected()) {
      ...
      if (_indexConsumer == -1) {
        // Requests for myself
        TransportRequestManager.sharedInstance.requestGetRequestsForMe(forceLoad, EnumRouteType.service, (responseDataModel) {
          hideProgressHUD();
        ...
        TransportRequestManager.sharedInstance.requestGetServiceRequestsForConsumer(consumer, forceLoad, (responseDataModel) {
          hideProgressHUD();
                  ...
                  child: Autocomplete<AutoCompleteConsumerSearchItem>(
                    ...
                    fieldViewBuilder: (BuildContext context, TextEditingController textEditingController, FocusNode focusNode, VoidCallback onFieldSubmitted) {
                      ...
                      return TextFormField(
                        ...
                        decoration: AppStyles.searchInputDecoration.copyWith(prefixIcon: const Icon(Icons.search), hintText: AppStrings.pleaseSelectConsumers),
                      );
                    },
