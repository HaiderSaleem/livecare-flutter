...
import 'package:livecare/screens/serviceRequests/homeservice.create/home_service_summary_screen.dart';
import 'package:livecare/utils/utils_date.dart';
import '../viewModel/home_service_request_view_model.dart';

class HomeServiceRequestCreateRecurringScreen extends BaseScreen {
  final HomeServiceRequestViewModel? vmRequest;

  const HomeServiceRequestCreateRecurringScreen({Key? key, required this.vmRequest}) : super(key: key);

  @override
  _HomeServiceRequestRecurringScreenState createState() => _HomeServiceRequestRecurringScreenState();

}

class _HomeServiceRequestRecurringScreenState
    extends BaseScreenState<HomeServiceRequestCreateRecurringScreen> {
  bool _isRepeat = true;
  ...
  gotoHomeServiceSummaryScreen() {
    Navigator.push(
      context,
      createRoute(
          HomeServiceSummaryScreen(vmRequest: widget.vmRequest)),
    );
  }
