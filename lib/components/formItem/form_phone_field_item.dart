...
class FormPhoneFieldItem extends BaseScreen {
  ...
  @override
  _FormPhoneFieldItemState createState() => _FormPhoneFieldItemState();

}

class _FormPhoneFieldItemState
    extends BaseScreenState<FormPhoneFieldItem> {
  ...
  @override
  void didUpdateWidget(FormPhoneFieldItem oldWidget) {
