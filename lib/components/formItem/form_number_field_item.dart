...
class FormNumberFieldItem extends BaseScreen {
  ...
  @override
  _FormNumberFieldItemState createState() =>
      _FormNumberFieldItemState();
}

class _FormNumberFieldItemState
    extends BaseScreenState<FormNumberFieldItem> {
  ...
  @override
  void didUpdateWidget(FormNumberFieldItem oldWidget) {
          ...
          RichText(
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                    text: _asterisk,
                    style: AppStyles.textCellTitleBoldStyle.copyWith(color: Colors.red)),
              ],
            ),
          ),
          const SizedBox(
